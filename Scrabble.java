...
public class Scrabble {
	...
	public static void playHand(String hand) {
		...
		while (hand.length() > 0) {
			...
			if (!input.equals(".")) {
				...
				//// else if ((isWordInDictionary(input)) && (MyString.subsetOf(input, hand) == false)) {
	...
	public static void playGame() {
		...
		while (true) {
			...
			if ((input.equals("n")) && (input.equals("e"))) System.out.println("Error input, please type n to deal a new hand, or e to end the game:");
		}
	}
